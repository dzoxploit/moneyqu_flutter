...
class Ubahtujuankeuangan extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  _UbahtujuankeuanganState createState() => _UbahtujuankeuanganState();
...
class _UbahtujuankeuanganState extends State<Ubahtujuankeuangan> {
  String currency='';
  ...
  Future<void> _getTujuankeuanganById() async {
    final response = await Network().getData('/tujuan-keuangan/update/'+widget.id.toString());
    indexdata = json.decode(response.body)['data'];
    setState(() {
      namatujuankeuanganController = new TextEditingController(text:indexdata['nama_tujuan_keuangan']);
      kategoritujuankeuanganController = new TextEditingController(text:indexdata['kategori_tujuan_keuangan_id']);
      tanggalController = new TextEditingController(text:indexdata['nama_tagihan']);
      nominalController  = new TextEditingController(text:indexdata['nominal']);
      hutangController  = new TextEditingController(text:indexdata['hutang_id']);
      simpananController  = new TextEditingController(text:indexdata['simpanan_id']);
    });
  }

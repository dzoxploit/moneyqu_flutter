            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    Text(body,
                        style: TextStyle(
                            color: FlutterMoneyquColors.black,
                            fontSize: 13,
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                                ...
                                style: TextStyle(
                                    color: stock == true
                                        ? FlutterMoneyquColors.success
                                        : FlutterMoneyquColors.error,
                                    fontSize: 12,
      ...
      child: DropdownButtonHideUnderline(
        child: Theme(
          data: Theme.of(context).copyWith(
            canvasColor: FlutterMoneyquColors.initial,
          ),
          child: DropdownButton<String>(
            ...
            iconSize: 20,
            elevation: 1,
            style: TextStyle(color: FlutterMoneyquColors.white),
